...
router.get(
  '/',
  [
    query('q').exists().bail().customSanitizer(toLowerCaseSanitizer),
    query('subcategories').toArray().customSanitizer(arrayToLowerCaseSanitizer),
    query('features').toArray().customSanitizer(arrayToMongoIdsSanitizer),
    query('category').optional().customSanitizer(toLowerCaseSanitizer),
